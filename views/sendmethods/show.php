...
<div class="panel panel-default">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-6">
                <div class="btn-group btn-group-sm" role="group">
                    <a href="/verzendmethodes/overzicht/all" type="button" class="btn btn-default <?php if($showFilter === 'all') { echo 'disabled'; } ?>">alles</a>
                    <a href="/verzendmethodes/overzicht/active" type="button" class="btn btn-default <?php if($showFilter === 'active') { echo 'disabled'; } ?>">actief</a>
                    <a href="/verzendmethodes/overzicht/inactive" type="button" class="btn btn-default <?php if($showFilter === 'inactive') { echo 'disabled'; } ?>">inactief</a>
                </div>
            </div>
    ...
    <table class="table table-striped table-responsive table-bordered table-couponShow sortable">
        ...
        foreach ($showMethods as $showMethod) {
            ...
            <tr>
                ...
                <td><a href="/verzendmethodes/bewerken/<?php echo $showMethod->getId(); ?>">Bewerken</a></td>
            </tr>
        <?php
        }
        ?>
    ...
    <div class="panel-footer">
        <a href="/verzendmethodes/nieuw">Toevoegen</a>
    </div>
</div>
<script type="text/javascript">
    ...
    $('#submit').on('click', function() {
        ...
        window.location.href = "/verzendmethodes/overzicht/" + value;
